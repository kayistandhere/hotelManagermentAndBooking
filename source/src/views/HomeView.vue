  ...
  <main>
      ...
      <div class="container">
        ...
        <div class="row g-4 g-lg-5">
          ...
          <div class="col-lg-6 position-relative mb-4 mb-md-0">
            ...
            <!-- Info -->
            <p class="mb-4">
              Chúng tôi mang đến cho bạn không chỉ một lựa chọn lưu trú mà còn
              là trải nghiệm phù hợp túi tiền của bạn để tận hưởng sự sang trọng
            </p>
            ...
            <div class="hstack gap-4 flex-wrap align-items-center">
              ...
              <!-- Story button -->
              <a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/watch?v=aw8d2f3xfPA&t=229s"
                class="d-block">
                <!-- Avatar -->
        ...
        <div class="row">
          <div class="col-xl-12 position-relative mt-n3 mt-xl-n9">
            ...
            <form class="card shadow rounded-3 position-relative p-4 pe-md-5 pb-5 pb-md-4" @submit.prevent="searchRoom">
                ...
                <div class="col-lg-3">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <!-- Date input -->
                      <input ref="date" type="date" class="form-control" v-model="formData.checkIn" />
                    </div>
                  </div>
                </div>
                <!-- Check out -->
                <div class="col-lg-3">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <!-- Date input -->
                      <input ref="datetime" type="date" class="form-control" v-model="formData.checkOut" />
                    </div>
                  </div>
                </div>
                <!-- Guest -->
                ...
                <div class="col-lg-3">
                  <div class="form-control-border form-control-transparent form-fs-md d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <select v-model="formData.peopleNumber" class="form-select js-choice form-control">
                ...
                <div class="col-lg-3">
                  <div class="form-control-border form-control-transparent form-fs-md d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <select v-model="formData.typeRoomId" class="form-select js-choice form-control">
                        <option value="">Chọn một tùy chọn</option>
    ...
    <section>
      <div class="container">
        ...
        <div class="row g-4">
          <!-- Hotel item -->
          <div class="col-sm-6 col-xl-3" :key="index" v-for="(room, index) in rooms">
            <!-- Card START -->
            <div class="card card-img-scale overflow-hidden bg-transparent" :key="room.id">
              <router-link :to="'/Room/bookRoom/' + room.id">
                <!-- Image and overlay -->
                <div class="card-img-scale-wrapper rounded-3">
                  <!-- Image -->
                  <img :src="room.roomPicture" class="card-img" alt="hotel image" @click="getRoomById(rooms.id)" />
                  <!-- Badge -->
                ...
                <div class="card-body px-2">
                  <!-- Title -->
                  <h5 class="card-title">
                    <a class="stretched-link"> {{ room.name }}</a>
                  </h5>
                  <!-- Price and rating -->
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <h6 class="mb-0">
                      4.5<i class="bi-solid bi-star text-warning ms-1"></i>
                    </h6>
                  </div>
                </div>
              </router-link>
...
export default {
  ...
  methods: {
    getAll() {
      this.$request
        .get("https://localhost:7103/user/room/get-top-new")
        .then((res) => {
          this.rooms = res.data;
        });
    },
    ...
    searchRoom() {
      ...
      console.log("xinchao roomList",formData);
    },
    showRoomType() {
      this.$request
