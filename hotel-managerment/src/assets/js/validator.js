...
function Validator(options) {
    ...
    if(formElement) {
        ...
        formElement.onsubmit = function(e) {
            ...
            // lặp qua từng rula và validate luôn 
...
Validator.isEmail = function(selector , messager) {
    return {
        selector: selector,
        test: function(value) {
...
Validator.isColor = function(selector , messager) {
    return {
        selector: selector,
        test: function(value) {
...
Validator.isMinLength = function(selector , min , messager) {
    return {
        selector: selector,
        test: function(value) {
...
Validator.isComfirmed = function(selector , getConfirmValue, messager) {
    return {
        selector : selector,
        test : function(value) {
